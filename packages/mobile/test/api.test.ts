 ...
 *
 * Pure fetch-based code with no React/React Native dependencies,
 * so it can be tested with node:test directly.
 *
 * Run: npx tsx --test packages/mobile/test/api.test.ts
 */
...
// ===========================================================================
// Session filtering — pure logic extracted from index.tsx
// ===========================================================================

describe("session filtering logic", () => {
  // This tests the same logic used in index.tsx's filteredSessions useMemo:
